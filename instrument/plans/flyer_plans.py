...
def VPBatchFly2d(flyer, scan_parms):
	...
	#Eiger setup
	#! caput('dp_eiger_xrd91:cam1:TriggerMode', 0)
	#! caput('dp_eiger_xrd91:cam1:ManualTrigger',0)
	#! caput ('dp_eiger_xrd91:cam1:FWEnable',1)
	#! caput ('dp_eiger_xrd91:cam1:SaveFiles',1)
	#! caput ('dp_eiger_xrd91:cam1:FWAutoRemove',1)
	#! caput('dp_eiger_xrd91:cam1:NumTriggers',1)
...
def VPFlyScan2d(vpFlyer, x_center, x_width, x_step_size,
	...
	x_start, x_stop, * = unCenterCoords(x_center, x_width, x_step_size)
	y_start, y_stop, * = unCenterCoords(y_center, y_width, y_step_size)
...
#		_md['hints'].update({'dimensions': dimensions})
	...
	yield from bps.fly(vpFlyer, md = _md)
