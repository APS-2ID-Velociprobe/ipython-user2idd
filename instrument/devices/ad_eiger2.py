...
# Borrowed from 4-id-polar which in turn was adapted from NSLS-II CHX
...
EIGER_root_dir = '/local/home/dpuser/data2/velociprobe/'
BS_root_dir = '/mnt/micdata2/velociprobe/'
exp_dir = '2021-2/test_bluesky/'
...
class LocalEigerDetector(LocalTrigger, DetectorBase):
	...
	def __init__(self, *args, exp_dir = exp_dir, BS_root_dir = BS_root_dir, EIGER_root_dir = EIGER_root_dir, **kwargs):
		super().__init__(*args, **kwargs)
		self.EIGER_FILES_ROOT = EIGER_root_dir + exp_dir
		self.BLUESKY_FILES_ROOT = BS_root_dir + exp_dir
	...
	@property
	def file(self):
		return Component(EigerSimulatedFilePlugin, suffix='cam1:', write_path_template=self.EIGER_FILES_ROOT, read_path_template=self.BLUESKY_FILES_ROOT)
